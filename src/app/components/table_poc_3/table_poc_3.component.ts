...
@Component({
  ...
  templateUrl: './table_poc_3.component.html',
  styleUrl: './table_poc_3.component.scss',
})
export class TablePoc3Component {
  title = 'Table POC 3';
  size = 'md';
  ...
  showFilter = false;
  noData = false;
  ariaLabelledby = 'This is a table POC 3';
  ariaDescribedby = 'This is a table POC 3';
